...
function optionsframework_options(){
    ...
    $options[] = array(
        'name'=>__('站点图标','moedog'),
        'id'=>'site_ico',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/images/favicon.ico',
        'type'=>'upload');
    $options[] = array(
        'name'=>__('通知设置','moedog'),
    ...
    $options[] = array(
        ...
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/images/index_image.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>__('主页布局','moedog'),
    ...
    $options[] = array(
        ...
        'id'=>'fa_url',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/css/font-awesome.min.css',
        'type'=>'text');
    $options[] = array(
        'name'=>__('自定义jQuery','moedog'),
        'desc'=>__('自定义jQuery链接，留空将从本地加载','moedog'),
        'id'=>'jq_url',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/js/jquery.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>__('主题JS','moedog'),
    ...
    $options[] = array(
        ...
        'id'=>'weixin_image',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/images/weixin.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>__('微信收款码','moedog'),
        'desc'=>__('上传你的微信收款二维码图片，图片尺寸要大于200px','moedog'),
        'id'=>'wechatpayqr_url',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/images/wechatpayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>__('支付婊收款码','moedog'),
        'desc'=>__('上传你的支付婊收款二维码图片，图片尺寸要大于200px','moedog'),
        'id'=>'alipayqr_url',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/images/alipayqr.png',
        'type'=>'upload');
    $options[] = array(
    ...
    $options[] = array(
        'name'=>__('顶部图片','moedog'),
        'id'=>'background_image',
        'std'=>'https://cdn-js.moeworld.top/gh/KJZH001/Moe-kratos-pjax@'.KRATOS_VERSION.'/static/images/background.jpg',
        'type'=>'upload');
    $options[] = array(
