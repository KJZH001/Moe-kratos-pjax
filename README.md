...
当前本主题**需要在PHP 8.4.33运行**，理论上兼容PHP7.4，但对于低于8.4的PHP，可能会在运行时出现任何不可预估的问题
...
即使本主题已经在您的站点上能够正常工作，我也不建议您更新任何插件或Wordpress本体，原因同上，**任何一次更新都可能面临着站点损坏**
<br>如果站点出现异常，那么也只有您自己能去修复它，我们不会（也无法）为此提供任何帮助
