...
function get_client_ip() {
    ...
    // 然后考虑 X-Forwarded-For（可能是多个 IP 逗号分隔）
...
// 服务器侧：判断是否应减少动效
// 若应该关闭动画，则返回为true
function moe_reduce_motion_requested(): bool {
